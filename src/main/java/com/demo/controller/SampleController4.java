...
public class SampleController4 {
	...
	// http://localhost:8080/controller/doJ?name=홍길동&age=100
	@RequestMapping("doJ")
	...
	// 파라미터 값을 제공해도 @ModelAttribute 를 사용 안하면, jsp에서 참조가 안됨.
	// http://localhost:8080/controller/doK?name=홍길동&age=100
	...
	// http://localhost:8080/controller/doL
	// Model 객체 : 메서드안의 데이타(객쳬)를 뷰(jsp)에 전달하는 기능을 제공.
	@RequestMapping("doL")
	public String doL(Model model) {
		...
		// 작업
		model.addAttribute("pdt", product); // model.addAttribute("jsp참조이름", product);
